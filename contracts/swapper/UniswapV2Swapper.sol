...
import {Ownable} from "../mocks/anchor_fake/open-zeppelin/contracts/access/Ownable.sol";
import {IERC20} from "../mocks/anchor_fake/open-zeppelin/contracts/token/ERC20/IERC20.sol";
import {SafeERC20} from "../mocks/anchor_fake/open-zeppelin/contracts/token/ERC20/SafeERC20.sol";
...
import "../mocks/anchor_fake/open-zeppelin/contracts/math/SafeMath.sol";
 ...
 */
contract UniswapV2Swapper is ISwapperV1, Ownable {
    ...
    function getAmountOutMin(address _tokenIn, address _tokenOut, uint256 _amountIn) external view override returns (uint256) {
        ...
        uint256[] memory amountOutMins = IUniswapV2Router02(UniswapRouterV2).getAmountsOut(_amountIn, path);
